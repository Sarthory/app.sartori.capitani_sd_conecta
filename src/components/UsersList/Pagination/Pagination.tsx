...
export default function Pagination() {
  const { searchQuery, actualPage, setIsLoading, setUsersList, setActualPage } = useGlobalContext();
  ...
  return (
    <PaginationContainer data-testid="pagePagination">
      <button
      ...
      <span data-testid="actualPage">Page: {actualPage}</span>

      <button data-testid="nextPageBtn" title="Next page" onClick={() => handleChangePage('next')}>
        <svg viewBox="0 0 24 24">
